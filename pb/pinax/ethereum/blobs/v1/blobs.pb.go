...
type Slot struct {
	...
	Root          []byte                 `protobuf:"bytes,2,opt,name=root,proto3" json:"root"`
	ProposerIndex uint64                 `protobuf:"varint,3,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index"`
	ParentRoot    []byte                 `protobuf:"bytes,4,opt,name=parent_root,json=parentRoot,proto3" json:"parent_root"`
	StateRoot     []byte                 `protobuf:"bytes,5,opt,name=state_root,json=stateRoot,proto3" json:"state_root"`
	BodyRoot      []byte                 `protobuf:"bytes,6,opt,name=body_root,json=bodyRoot,proto3" json:"body_root"`
	...
	Timestamp     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=timestamp,proto3" json:"timestamp"`
	Blobs         []*Blob                `protobuf:"bytes,10,rep,name=blobs,proto3" json:"blobs"`
}
...
func (x *Slot) GetBlockNumber() uint64 {
	if x != nil {
...
var file_pinax_ethereum_blobs_v1_blobs_proto_rawDesc = []byte{
	...
	0xe2, 0x02, 0x0a, 0x04, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	0x65, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x6f, 0x64, 0x79, 0x5f,
	0x72, 0x6f, 0x6f, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x62, 0x6f, 0x64, 0x79,
	...
	0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x4e,
	...
	0x33, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x62, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d,
...
var file_pinax_ethereum_blobs_v1_blobs_proto_goTypes = []interface{}{
	(*Slot)(nil),                  // 0: pinax.ethereum.blobs.v1.Slot
	(*Blob)(nil),                  // 1: pinax.ethereum.blobs.v1.Blob
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_pinax_ethereum_blobs_v1_blobs_proto_depIdxs = []int32{
	2, // 0: pinax.ethereum.blobs.v1.Slot.timestamp:type_name -> google.protobuf.Timestamp
	1, // 1: pinax.ethereum.blobs.v1.Slot.blobs:type_name -> pinax.ethereum.blobs.v1.Blob
