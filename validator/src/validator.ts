...
const CHAIN_CONFIGS: Record<string, ChainConfig> = {
	eth: {
		...
		executionRpcUrl: "http://eth.rpcx.kan-prod-rpc-a.pinax.io",
	...
	sepolia: {
		...
		executionRpcUrl: "http://sepolia.rpcx.kan-prod-rpc-a.pinax.io",
	...
	gnosis: {
		...
		executionRpcUrl: "http://gnosis.rpcx.kan-prod-rpc-a.pinax.io",
